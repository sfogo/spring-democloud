...
_Note : with a docker containerized application, one option is fail fast and use the [always restart](https://docs.docker.com/engine/reference/run/#restart-policies-restart) policy._
